...
import { ArrowRight, Home, Shield, Award, Phone } from 'lucide-react';
...
export default function Cta() {
  ...
  const stats = [
    ...
    { value: '100%', label: 'Satisfaction Client', icon: Shield },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Bénéficiez d'une isolation thermique performante et d'une rénovation extérieure de
                qualité. Obtenez votre devis gratuit et découvrez les aides disponibles.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Certifié RGE - Partenaire des principales aides à la rénovation
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Travaux garantis et assurance décennale
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Aides Maximisées</h3>
              <p className="text-sm text-muted-foreground">
                Accompagnement pour toutes vos démarches
              </p>
            </div>
          </div>
        </div>
